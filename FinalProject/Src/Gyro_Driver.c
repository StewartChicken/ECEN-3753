...
/**
  * @brief Sample the Y Velocity Rate of the Gyro and return
  * @retval 16 bit integer representing the y velocity of the gyro
  */
...
/**
  * @brief Sample the X Velocity Rate of the Gyro and return
  * @retval 16 bit integer representing the x velocity of the gyro
  */
